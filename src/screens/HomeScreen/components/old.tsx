...
export default ({
  ...
  const [frontSideSizeRef, setFrontSideSizeRef] = useState(0);
  ...
  return (
    <FlipCard flipVertical flip={isCardFlipped} friction={10}>
      <View
        onLayout={(event) =>
          setFrontSideSizeRef(event.nativeEvent.layout.height)
        }
      ...
      <View style={[aggregatedContainerStyles, {height: frontSideSizeRef}]}>
        <View style={[styles.section, styles.header]}>
          <View style={[common.styles.row, common.styles.centered_vertically]}>
            <Text style={[typography.styles.body_bold, styles.header_text]}>
              {HOURS_AS_TIME_STRING[assignmentHour]}
        ...
        <View
          style={[
            styles.section,
            styles.header,
            styles.medicine_list_container,
            {paddingVertical: 10},
          ]}>
          <Pressable>
            <Text
